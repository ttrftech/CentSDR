 ...
 * Board identifier.
 */
#define BOARD_NANOSDR_STM32_F303
#define BOARD_NAME              "NanoSDR"
 ...
 * PA8  - MCO 						(alternate 0).
 * PA9  - IC2C_SCL				    (alternate 4).
 * PA10 - IC2C_SDA				    (alternate 4).
...
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_100M(0) |          \
                                     ...
                                     PIN_OSPEED_100M(GPIOC_USB_DISC) | \
                                     PIN_OSPEED_100M(15))
